...
class OpenAiService
{
    public function generatePromptFromImage(UploadedFile $image): string
    {
        ...
        // Additional logic to call OpenAI API and generate a prompt based on the image data
